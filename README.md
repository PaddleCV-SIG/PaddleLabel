...
- 【2022-11-30】 :fire: PaddleLabel 0.5 版本发布！
  ...
  - 【分割】(1)优化语义分割及实例分割关于实例的区分，实例分割通过'确认轮廓'来区分每个实例; (2)新增根据类别或根据实例选择颜色显示模式; (3)修复交互式分割localStorage爆炸问题。
...
<div align="center">
<img src="https://user-images.githubusercontent.com/35907364/204429438-f2e3dde4-c7a8-4434-8a2a-4cbd23ba5fe0.png"  width = "200" />
</div>
