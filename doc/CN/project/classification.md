...
- [图像分类项目](#%E5%9B%BE%E5%83%8F%E5%88%86%E7%B1%BB%E9%A1%B9%E7%9B%AE)
    - [数据集结构](#%E6%95%B0%E6%8D%AE%E9%9B%86%E7%BB%93%E6%9E%84)
...
PaddleLabel 支持**单分类**和**多分类**两种图像分类项目。其中单分类项目每张图片只对应一个类别，多分类项目一张图片可以对应多个类别。

## 数据集结构

### 单分类

每张图片只有一个类别，也称为 ImageNet 格式。新建单分类标注任务时，数据集路径填写待标注图片所在文件夹绝对路径。
