...
logging.basicConfig(level=logging.ERROR, filename='pplabel.log', filemode='w', format='%(name)s - %(levelname)s - %(message)s')
...
request_id_timeout = 2  # reject requests with the same request_id within request_id_timeout seconds
