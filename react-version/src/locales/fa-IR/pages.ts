export default {
  'pages.layouts.userLayout.title': 'PP-Labeling ، الكل في واحد حل ذكي لوضع العلامات',
  'pages.login.accountLogin.tab': 'ورود به حساب کاربری',
  'pages.login.accountLogin.errorMessage': 'نام کاربری / رمزعبور نادرست (مدیر / pplabeling)',
  'pages.login.username.placeholder': 'نام کاربری: مدیر یا کاربر',
  'pages.login.username.required': 'لطفا نام کاربری خود را وارد کنید!',
  'pages.login.password.placeholder': 'رمز عبور: pplabeling',
  ...
  'pages.login.getFakeCaptchaMessage': 'احصل على رمز التحقق بنجاح إنه 1234',
